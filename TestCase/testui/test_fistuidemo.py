...
class   TestFifstUIDemo:
    ...
    def test_page(self):
            driver = self.start()
            driver.get("C:\\software\\apache-tomcat-7.0.79\\webapps\\wode\\demo1.html")
            ...
            # file.clear()
            # # 输入
            # file.send_keys("‪D:\\software\\apache-tomcat-7.0.79\\webapps\\xuepl\\demo.html")cp1256_bin
            ...
            checkbox = driver.find_element_by_xpath(
                    "//td[contains(text(),'checkbox:多选框')]/following-sibling::td//input[1]")
            # 点击
            checkbox.click()
            time.sleep(2)
            checkbox.click()
            ...
            checkboxes = driver.find_elements_by_xpath(
                    "//td[contains(text(),'checkbox:多选框')]/following-sibling::td//input")
            for c in checkboxes:
                    c.click()
            time.sleep(2)
            self.quit(driver)
